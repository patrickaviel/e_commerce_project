...
<head>
    ...
    <!-- Personal CSS -->
    <link rel="stylesheet" href="<?php base_url() ?>/assets/stylesheets/admin_users.css">
    <!-- fontawesome cdn -->
            ...
            <div class="container-fluid">
              <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                ...
                <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 px-2 justify-content-center mb-md-0">
                    ...
                    <li><a href="/admin/users" class="nav-link px-2 text-warning border rounded border-warning">Users</a></li>
                </ul>
